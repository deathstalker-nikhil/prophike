...
<form action="" method="post" id="floating-contact" >
	...
	<div id="contact-page" class="container">
    	<div class="bg">    	
    		<div class="row"> 
    		<h2 class="title text-center" style="font-size: 30px;">DISCLAIMER</h2>
    		<div class="col-md-4">
	<img src="/assets/images/disclaimer.png">
</div>
    		  <div class="col-md-8">
    	<p style="font-size: 16px; line-height:1.75; font-family: 'Roboto', sans-serif;">The information contained in this website is for

general information purposes only. The information is provided by 

PropHike and while we endeavour to keep the information up to 

date and correct, we make no representations or warranties of any 

kind, express or implied, about the completeness, accuracy, 

reliability, suitability or availability with respect to the website or 
